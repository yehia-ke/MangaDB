...
namespace Repository.Repository
{
    public class ViewAllOfferedUnsubscribedPlans
    {
        ...
        public async Task<List<Dictionary<string, object>>> GetAllOfferedUnsubscribedPlans(string mobileNoUnsubscribedPlans)
        {
            ...
            try
            {
                ...
                var command = new SqlCommand($"EXEC Unsubscribed_Plans @mobile_num = '{mobileNoUnsubscribedPlans}'", connection);
